...
#define MAXVER_INTERNALNAME "cmdex.dlx\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "cmdex.dlx\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "MAXScript CMD.exe command line runner (dlx)\0"//should  be overidden on a per-dll level
